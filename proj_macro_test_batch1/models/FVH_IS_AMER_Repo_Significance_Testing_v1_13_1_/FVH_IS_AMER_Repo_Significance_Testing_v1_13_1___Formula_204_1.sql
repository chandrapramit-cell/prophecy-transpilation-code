...
WITH TextInput_203 AS (
  ...
  FROM {{ ref('seed_FVH_IS_AMER_Repo_Significance_Testing_v1_13_1__203')}}

),

TextInput_203_cast AS (

  {#Converts key fields and file path columns to a consistent text format and normalizes column names with spaces so records can be used reliably in reports and exports.#}
  SELECT 

...
Formula_170_to_Formula_59_2 AS (
  ...
  FROM {{ ref('FVH_IS_AMER_Repo_Significance_Testing_v1_13_1___Formula_170_to_Formula_59_2')}}
...
AppendFields_245 AS (
  ...
  INNER JOIN Formula_170_to_Formula_59_2 AS in1
     ON TRUE

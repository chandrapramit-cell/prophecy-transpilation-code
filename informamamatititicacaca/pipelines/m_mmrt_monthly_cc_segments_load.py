...
args = PipelineArgs(
    label = "m_mmrt_monthly_cc_segments_load",
    version = 1,
    auto_layout = False,
...
with Pipeline(args) as pipeline:
    ...
    _11_0_1__database___generate_monthly_financialsm_mmrt_monthly_cc_segments_load_sq_mrt_card_trans_derivations = Process(
        name = "{11_0_1}_Database___Generate_Monthly_Financialsm_mmrt_monthly_cc_segments_load_SQ_MRT_CARD_TRANS_DERIVATIONS",
    ...
    (
        _11_0_1__database___generate_monthly_financialsm_mmrt_monthly_cc_segments_load_sq_mrt_card_trans_derivations

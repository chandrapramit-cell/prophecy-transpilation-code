...
TextInput_137_cast AS (
  ...
  SELECT 
    CAST("NAME" AS STRING) AS "NAME",
    AGE AS AGE,
    "NUMBER OF YEARS OF EDUCATION PARANTHESESOPENSTARTING AT 1ST GRADEPARANTHESESCLOSE" AS "NUMBER OF YEARS OF EDUCATION PARANTHESESOPENSTARTING AT 1ST GRADEPARANTHESESCLOSE"
...
Imputationv3_67_0 AS (
  ...
  SELECT 
    ...
    CASE
      WHEN isnull(2012_SALES)
        THEN _2012_SALES_AGG
      ELSE 2012_SALES
    END AS "2012_SALES",
    CASE
      WHEN isnull(2013_SALES)
        THEN _2013_SALES_AGG
      ELSE 2013_SALES
    END AS "2013_SALES",
    CASE
      WHEN isnull(2014_SALES)
...
Union_273 AS (
  ...
  {{
    prophecy_basics.UnionByName(
      ...
      [
        '[{"name": "JOB_TYPE", "dataType": "String"}, {"name": "OTR_INSTALL", "dataType": "String"}, {"name": "\\"SAMPLE\\"", "dataType": "String"}, {"name": "CHK_BAL", "dataType": "String"}, {"name": "PROPERTY", "dataType": "String"}, {"name": "DEBTOR_GUARANTOR", "dataType": "String"}, {"name": "DEFAULT", "dataType": "String"}, {"name": "AGE", "dataType": "Integer"}, {"name": "TELEPHONE", "dataType": "String"}, {"name": "GENDER_MARITAL", "dataType": "String"}, {"name": "LENGTH_RES", "dataType": "Integer"}, {"name": "FOREIGN_WORKER", "dataType": "String"}, {"name": "CREDIT_HIST", "dataType": "String"}, {"name": "DURATION", "dataType": "Integer"}, {"name": "TENURE", "dataType": "String"}, {"name": "DEPENDENTS", "dataType": "Integer"}, {"name": "NUM_LOANS", "dataType": "Integer"}]', 
        '[{"name": "JOB_TYPE", "dataType": "String"}, {"name": "OTR_INSTALL", "dataType": "String"}, {"name": "\\"SAMPLE\\"", "dataType": "String"}, {"name": "CHK_BAL", "dataType": "String"}, {"name": "PROPERTY", "dataType": "String"}, {"name": "DEBTOR_GUARANTOR", "dataType": "String"}, {"name": "DEFAULT", "dataType": "String"}, {"name": "AGE", "dataType": "Integer"}, {"name": "TELEPHONE", "dataType": "String"}, {"name": "GENDER_MARITAL", "dataType": "String"}, {"name": "LENGTH_RES", "dataType": "Integer"}, {"name": "FOREIGN_WORKER", "dataType": "String"}, {"name": "CREDIT_HIST", "dataType": "String"}, {"name": "DURATION", "dataType": "Integer"}, {"name": "TENURE", "dataType": "String"}, {"name": "DEPENDENTS", "dataType": "Integer"}, {"name": "NUM_LOANS", "dataType": "Integer"}]'
      ], 
      'allowMissingColumns'
    )
  ...
  SELECT 
    ...
    CASE
      WHEN isnull(2012_SALES)
        THEN _2012_SALES_AGG
      ELSE 2012_SALES
    END AS "2012_SALES_IMPUTEDVALUE",
    CASE
      WHEN isnull(2013_SALES)
        THEN _2013_SALES_AGG
      ELSE 2013_SALES
    END AS "2013_SALES_IMPUTEDVALUE",
    CASE
      WHEN isnull(2014_SALES)
        THEN _2014_SALES_AGG
      ELSE 2014_SALES
    END AS "2014_SALES_IMPUTEDVALUE",
    *
...
Union_224 AS (
  ...
  {{
    prophecy_basics.UnionByName(
      ...
      [
        '[{"name": "ITEM_ID", "dataType": "Double"}, {"name": "\\"2013_SALES\\"", "dataType": "Double"}, {"name": "\\"2012_SALES\\"", "dataType": "Double"}, {"name": "\\"2014_SALES\\"", "dataType": "Double"}]', 
        '[{"name": "ITEM_ID", "dataType": "Integer"}, {"name": "\\"2013_SALES_IMPUTEDVALUE\\"", "dataType": "Double"}, {"name": "\\"2012_SALES_IMPUTEDVALUE\\"", "dataType": "Double"}, {"name": "\\"2014_SALES\\"", "dataType": "Integer"}, {"name": "\\"2014_SALES_IMPUTEDVALUE\\"", "dataType": "Double"}, {"name": "\\"2013_SALES\\"", "dataType": "Integer"}, {"name": "ITEM_ID_IMPUTEDVALUE", "dataType": "Double"}, {"name": "\\"2012_SALES\\"", "dataType": "Integer"}]', 
        '[{"name": "\\"2013_SALES_INDICATOR\\"", "dataType": "Integer"}, {"name": "ITEM_ID_INDICATOR", "dataType": "Integer"}, {"name": "ITEM_ID", "dataType": "Double"}, {"name": "\\"2014_SALES\\"", "dataType": "Double"}, {"name": "\\"2012_SALES_INDICATOR\\"", "dataType": "Integer"}, {"name": "\\"2014_SALES_INDICATOR\\"", "dataType": "Integer"}, {"name": "\\"2013_SALES\\"", "dataType": "Double"}, {"name": "\\"2012_SALES\\"", "dataType": "Double"}]', 
        '[{"name": "ITEM_ID", "dataType": "Double"}, {"name": "\\"2013_SALES\\"", "dataType": "Double"}, {"name": "\\"2012_SALES\\"", "dataType": "Double"}, {"name": "\\"2014_SALES\\"", "dataType": "Double"}]'
      ], 
      'allowMissingColumns'
    )
...
Union_247 AS (
  ...
  {{
    prophecy_basics.UnionByName(
      ...
      [
        '[{"name": "NAME", "dataType": "String"}, {"name": "NUMBER OF YEARS IN CURRENT POSITION", "dataType": "Number"}, {"name": "NUMBER OF YEARS OF EDUCATION PARANTHESESOPENSTARTING AT 1ST GRADEPARANTHESESCLOSE", "dataType": "Number"}, {"name": "AGE", "dataType": "Number"}, {"name": "SALARY", "dataType": "Number"}, {"name": "MANAGER", "dataType": "String"}, {"name": "POSITION TITLE", "dataType": "String"}, {"name": "INPUT_HASH3_NAME", "dataType": "String"}, {"name": "INPUT_HASH2_NAME", "dataType": "String"}]', 
        '[{"name": "NAME", "dataType": "String"}, {"name": "NUMBER OF YEARS IN CURRENT POSITION", "dataType": "Number"}, {"name": "NUMBER OF YEARS OF EDUCATION PARANTHESESOPENSTARTING AT 1ST GRADEPARANTHESESCLOSE", "dataType": "Number"}, {"name": "AGE", "dataType": "Number"}, {"name": "SALARY", "dataType": "Number"}, {"name": "INPUT_HASH2_NAME", "dataType": "String"}]', 
        '[{"name": "NAME", "dataType": "String"}, {"name": "NUMBER OF YEARS IN CURRENT POSITION", "dataType": "Number"}, {"name": "NUMBER OF YEARS OF EDUCATION PARANTHESESOPENSTARTING AT 1ST GRADEPARANTHESESCLOSE", "dataType": "Number"}, {"name": "AGE", "dataType": "Number"}, {"name": "SALARY", "dataType": "Number"}, {"name": "MANAGER", "dataType": "String"}, {"name": "POSITION TITLE", "dataType": "String"}, {"name": "INPUT_HASH3_NAME", "dataType": "String"}, {"name": "INPUT_HASH2_NAME", "dataType": "String"}]', 
        '[{"name": "NAME", "dataType": "String"}, {"name": "NUMBER OF YEARS IN CURRENT POSITION", "dataType": "Number"}, {"name": "NUMBER OF YEARS OF EDUCATION PARANTHESESOPENSTARTING AT 1ST GRADEPARANTHESESCLOSE", "dataType": "Number"}, {"name": "AGE", "dataType": "Number"}, {"name": "SALARY", "dataType": "Number"}, {"name": "MANAGER", "dataType": "String"}, {"name": "POSITION TITLE", "dataType": "String"}, {"name": "INPUT_HASH3_NAME", "dataType": "String"}, {"name": "INPUT_HASH2_NAME", "dataType": "String"}]', 
        '[{"name": "NAME", "dataType": "String"}, {"name": "NUMBER OF YEARS IN CURRENT POSITION", "dataType": "Number"}, {"name": "NUMBER OF YEARS OF EDUCATION PARANTHESESOPENSTARTING AT 1ST GRADEPARANTHESESCLOSE", "dataType": "Number"}, {"name": "AGE", "dataType": "Number"}, {"name": "SALARY", "dataType": "Number"}, {"name": "MANAGER", "dataType": "String"}, {"name": "POSITION TITLE", "dataType": "String"}, {"name": "INPUT_HASH3_NAME", "dataType": "String"}, {"name": "INPUT_HASH2_NAME", "dataType": "String"}]'
      ], 
...
DateTime_292_0 AS (
  ...
  SELECT 
    (TO_CHAR((TRY_TO_DATE("LAST LOGIN DATETIME")), 'DY, DD MMMM, YYYY')) AS "LAST LOGIN DATE",
    *
...
DateTime_289_0 AS (
  ...
  SELECT 
    (TO_CHAR((TRY_TO_DATE((TO_TIMESTAMP(DOB, 'MMMM DD, YYYY')))), 'YYYY-MM-DD')) AS DOB_NEW,
    *
...
DateTime_296_0 AS (
  ...
  SELECT 
    (TO_CHAR((TRY_TO_DATE("JOIN DATE")), 'DY, MMMM DD, YYYY')) AS "JOIN DATE_NEW",
    *
...
DateTime_298_0 AS (
  ...
  SELECT 
    (TO_CHAR((TRY_TO_DATE((TO_TIMESTAMP("LAST SAVE DATE", 'MM-DD/YYYY')))), 'YYYY-MM-DD')) AS "LAST SAVE DATE_NEW",
    *
...
DateTime_288_0 AS (
  ...
  SELECT 
    (TO_CHAR((TRY_TO_DATE("JOIN DATE")), 'MMMM DD, YYYY')) AS "JOIN DATE_NEW",
    *
...
Union_301 AS (
  ...
  {{
    prophecy_basics.UnionByName(
      ...
      [
        '[{"name": "DOB", "dataType": "String"}, {"name": "JOIN DATE", "dataType": "Timestamp"}, {"name": "LAST LOGIN DATETIME", "dataType": "Timestamp"}, {"name": "LAST SAVE DATE", "dataType": "String"}, {"name": "CUSTOMER ID", "dataType": "Integer"}, {"name": "LAST LOGIN TIME", "dataType": "String"}, {"name": "DOB_NEW", "dataType": "String"}]', 
        '[{"name": "DOB", "dataType": "String"}, {"name": "JOIN DATE", "dataType": "Timestamp"}, {"name": "JOIN DATE_NEW", "dataType": "String"}, {"name": "LAST LOGIN DATETIME", "dataType": "Timestamp"}, {"name": "LAST SAVE DATE", "dataType": "String"}, {"name": "CUSTOMER ID", "dataType": "Integer"}, {"name": "LAST LOGIN TIME", "dataType": "String"}]', 
        '[{"name": "DOB", "dataType": "String"}, {"name": "JOIN DATE", "dataType": "Timestamp"}, {"name": "LAST LOGIN DATETIME", "dataType": "Timestamp"}, {"name": "LAST SAVE DATE", "dataType": "String"}, {"name": "CUSTOMER ID", "dataType": "Integer"}, {"name": "LAST LOGIN TIME", "dataType": "String"}, {"name": "LAST LOGIN TIME_NEW", "dataType": "String"}]', 
        '[{"name": "DOB", "dataType": "String"}, {"name": "JOIN DATE", "dataType": "Timestamp"}, {"name": "JOIN DATE_NEW", "dataType": "String"}, {"name": "LAST LOGIN DATETIME", "dataType": "Timestamp"}, {"name": "LAST SAVE DATE", "dataType": "String"}, {"name": "CUSTOMER ID", "dataType": "Integer"}, {"name": "LAST LOGIN TIME", "dataType": "String"}]', 
        '[{"name": "DOB", "dataType": "String"}, {"name": "JOIN DATE", "dataType": "Timestamp"}, {"name": "LAST LOGIN DATETIME", "dataType": "Timestamp"}, {"name": "LAST LOGIN DATE", "dataType": "String"}, {"name": "LAST SAVE DATE", "dataType": "String"}, {"name": "CUSTOMER ID", "dataType": "Integer"}, {"name": "LAST LOGIN TIME", "dataType": "String"}]', 
        '[{"name": "DOB", "dataType": "String"}, {"name": "JOIN DATE", "dataType": "Timestamp"}, {"name": "LAST LOGIN DATETIME", "dataType": "Timestamp"}, {"name": "LAST SAVE DATE_NEW", "dataType": "String"}, {"name": "LAST SAVE DATE", "dataType": "String"}, {"name": "CUSTOMER ID", "dataType": "Integer"}, {"name": "LAST LOGIN TIME", "dataType": "String"}]'
      ], 
      'allowMissingColumns'
    )
  }}
...
Union_219 AS (
  ...
  {{
    prophecy_basics.UnionByName(
      ...
      [
        '[{"name": "FIELD1_TILE_NUM", "dataType": "Number"}, {"name": "FIELD2_TILE_NUM", "dataType": "Number"}, {"name": "FIELD3_TILE_NUM", "dataType": "Number"}, {"name": "FIELD1", "dataType": "Number"}, {"name": "FIELD3", "dataType": "Number"}, {"name": "FIELD2", "dataType": "Float"}]', 
        '[{"name": "FIELD1_TILE_NUM", "dataType": "Number"}, {"name": "FIELD2_TILE_NUM", "dataType": "Number"}, {"name": "FIELD3_TILE_NUM", "dataType": "Number"}, {"name": "FIELD1", "dataType": "Number"}, {"name": "FIELD3", "dataType": "Number"}, {"name": "FIELD2", "dataType": "Float"}]', 
        '[{"name": "FIELD1_TILE_NUM", "dataType": "Number"}, {"name": "FIELD2_TILE_NUM", "dataType": "Number"}, {"name": "FIELD3_TILE_NUM", "dataType": "Number"}, {"name": "FIELD1", "dataType": "Number"}, {"name": "FIELD3", "dataType": "Number"}, {"name": "FIELD2", "dataType": "Float"}]', 
        '[{"name": "FIELD1_TILE_NUM", "dataType": "Number"}, {"name": "FIELD2_TILE_NUM", "dataType": "Number"}, {"name": "FIELD3_TILE_NUM", "dataType": "Number"}, {"name": "FIELD1", "dataType": "Number"}, {"name": "FIELD3", "dataType": "Number"}, {"name": "FIELD2", "dataType": "Float"}]'
      ], 

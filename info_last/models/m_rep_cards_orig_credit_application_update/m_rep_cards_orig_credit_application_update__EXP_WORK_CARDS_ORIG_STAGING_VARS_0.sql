...
SQ_WORK_CARDS_ORIG_STAGING_EXPR_20 AS (
...
EXP_WORK_CARDS_ORIG_STAGING_LOOKUP_25 AS (
  ...
  LEFT JOIN SQ_WORK_CARDS_ORIG_STAGING_EXPR_20 AS in1
...
EXP_WORK_CARDS_ORIG_STAGING_VARS_0 AS (
  ...
  FROM EXP_WORK_CARDS_ORIG_STAGING_LOOKUP_25 AS in0

...
EXP_ADDRESS_STAGING_LOOKUP_69 AS (
...
EXP_ADDRESS_STAGING_VARS_0 AS (
  ...
  FROM EXP_ADDRESS_STAGING_LOOKUP_69 AS in0
...
INS_ADDRESS_STAGING_add_missing_column_EXPR_68 AS (
...
FROM INS_ADDRESS_STAGING_add_missing_column_EXPR_68

...
Shortcut_to_SEQ_clid_EXPR_61 AS (
...
Shortcut_to_SEQ_adid_EXPR_62 AS (
  ...
  FROM Shortcut_to_SEQ_clid_EXPR_61 AS in0

),

EXP_CLIENT_ALIAS_LOOKUP_64 AS (
  ...
  LEFT JOIN Shortcut_to_SEQ_adid_EXPR_62 AS in1
...
EXP_CLIENT_ALIAS_VARS_0 AS (
  ...
  FROM EXP_CLIENT_ALIAS_LOOKUP_64 AS in0

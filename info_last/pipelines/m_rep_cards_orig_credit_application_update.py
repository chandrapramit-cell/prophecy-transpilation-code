...
with Pipeline(args) as pipeline:
    ...
    m_rep_cards_orig_credit_application_update__exp_work_cards_orig_staging_expr_19 = Process(
        name = "m_rep_cards_orig_credit_application_update__EXP_WORK_CARDS_ORIG_STAGING_EXPR_19",
        properties = ModelTransform(modelName = "m_rep_cards_orig_credit_application_update__EXP_WORK_CARDS_ORIG_STAGING_EXPR_19")
    )
    ...
    (
        m_rep_cards_orig_credit_application_update__exp_work_cards_orig_staging_expr_19._out(0)
    ...
    exp_work_cards_orig_staging_sp >> m_rep_cards_orig_credit_application_update__exp_work_cards_orig_staging_expr_19

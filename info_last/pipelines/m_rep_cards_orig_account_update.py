...
with Pipeline(args) as pipeline:
    ...
    m_rep_cards_orig_account_update__rtr_account_join_expr_42 = Process(
        name = "m_rep_cards_orig_account_update__RTR_ACCOUNT_JOIN_EXPR_42",
        properties = ModelTransform(modelName = "m_rep_cards_orig_account_update__RTR_ACCOUNT_JOIN_EXPR_42"),
        input_ports = ["in_0", "in_1"]
    )
    ...
    exp_account_change_sp >> m_rep_cards_orig_account_update__rtr_account_join_expr_42._in(1)
    (
        m_rep_cards_orig_account_update__rtr_account_join_expr_42._out(0)
        >> [m_rep_cards_orig_account_update__holds._in(0), m_rep_cards_orig_account_update__new_chooses._in(0),
    ...
    (
        ...
        >> [m_rep_cards_orig_account_update__rtr_account_join_expr_42._in(0),

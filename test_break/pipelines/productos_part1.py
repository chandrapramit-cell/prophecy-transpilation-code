...
with Pipeline(args) as pipeline:
    ...
    aka_server_uydb_1031 >> productos_part1__join_988_inner._in(5)
    ...
    aka_server_uydb_1030 >> productos_part1__join_988_inner._in(1)
    aka_server_uydb_1038 >> intermediate_productos_aka_server_uydb_1038
    (
        aka_server_uydb_1045._out(0)
        >> [intermediate_productos_aka_server_uydb_1045._in(0), productos_part1__join_988_inner._in(3)]
    )
    ...
    (
        ...
        >> [intermediate_productos_aka_server_uydb_1116._in(0), productos_part1__join_988_inner._in(4)]
    )
    (

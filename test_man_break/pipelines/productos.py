...
with Pipeline(args) as pipeline:
    ...
    aka_server_uydb_1030 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1030.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1031 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1031.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1032 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1032.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1033 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1033.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1034 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1034.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1035 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1035.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1036 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1036.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1037 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1037.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1038 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1038.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1039 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1039.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1040 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1040.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1041 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1041.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1042 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1042.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1043 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1043.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1044 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1044.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1045 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1045.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1046 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1046.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1047 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1047.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1048 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1048.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1116 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1116.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1128 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/productos/aka_Server_UYDB_1128.yml")
        ),
        input_ports = None
    )
    productos__union_895 = Process(
        name = "productos__Union_895",
        properties = ModelTransform(modelName = "productos__Union_895"),
    ...
    productos__aka_server_uydb_898 = Process(
        name = "productos__aka_Server_UYDB_898",
        properties = ModelTransform(modelName = "productos__aka_Server_UYDB_898")
    )
    productos__aka_server_uydb_900 = Process(
        name = "productos__aka_Server_UYDB_900",
        properties = ModelTransform(modelName = "productos__aka_Server_UYDB_900")
    )
    aka_server_uydb_1032._out(0) >> [productos__union_895._in(1), productos__union_895._in(21)]
    aka_server_uydb_1044 >> productos__union_895._in(32)
    aka_server_uydb_1042 >> productos__union_895._in(8)
    aka_server_uydb_1039 >> productos__union_895._in(6)
    aka_server_uydb_1047 >> productos__union_895._in(28)
    (
        aka_server_uydb_1041._out(0)
        >> [productos__union_895._in(23), productos__union_895._in(24), productos__union_895._in(25)]
    )
    aka_server_uydb_1046 >> productos__union_895._in(9)
    aka_server_uydb_1043 >> productos__union_895._in(31)
    aka_server_uydb_1031 >> productos__union_895._in(0)
    aka_server_uydb_1034._out(0) >> [productos__union_895._in(14), productos__union_895._in(15)]
    productos__union_895._out(0) >> [productos__aka_server_uydb_898._in(0), productos__aka_server_uydb_900._in(0)]
    aka_server_uydb_1040 >> productos__union_895._in(7)
    aka_server_uydb_1030 >> productos__union_895._in(29)
    aka_server_uydb_1038._out(0) >> [productos__union_895._in(5), productos__union_895._in(22)]
    aka_server_uydb_1045._out(0) >> [productos__union_895._in(18), productos__union_895._in(20)]
    aka_server_uydb_1037 >> productos__union_895._in(19)
    aka_server_uydb_1128._out(0) >> [productos__union_895._in(13), productos__union_895._in(30)]
    aka_server_uydb_1116._out(0) >> [productos__union_895._in(11), productos__union_895._in(12)]
    aka_server_uydb_1033 >> productos__union_895._in(2)
    aka_server_uydb_1035._out(0) >> [productos__union_895._in(3), productos__union_895._in(4)]
    aka_server_uydb_1048 >> productos__union_895._in(10)
    (
        aka_server_uydb_1036._out(0)
        >> [productos__union_895._in(16), productos__union_895._in(17), productos__union_895._in(26),
              productos__union_895._in(27)]
    )

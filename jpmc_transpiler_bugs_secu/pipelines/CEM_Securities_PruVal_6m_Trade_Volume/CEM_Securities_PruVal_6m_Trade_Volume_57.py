...
with Pipeline(args) as pipeline:
    cem_securities_pruval_6m_trade_volume_57__table_57_output4_macro_op = Process(
        name = "CEM_Securities_PruVal_6m_Trade_Volume_57__table_57_Output4_macro_op",
        properties = ModelTransform(modelName = "CEM_Securities_PruVal_6m_Trade_Volume_57__table_57_Output4_macro_op")
    )
    ...
    gem_credit_trad_1_57 >> cem_securities_pruval_6m_trade_volume_57__table_57_output4_macro_op

...
with Pipeline(args) as pipeline:
    ...
    right_s_1_part2__union_895 = Process(
        name = "right_s_1_part2__Union_895",
        properties = ModelTransform(modelName = "right_s_1_part2__Union_895"),
    ...
    right_s_1_part2__aka_server_uydb_898 = Process(
        name = "right_s_1_part2__aka_Server_UYDB_898",
        properties = ModelTransform(modelName = "right_s_1_part2__aka_Server_UYDB_898")
    )
    right_s_1_part2__aka_server_uydb_900 = Process(
        name = "right_s_1_part2__aka_Server_UYDB_900",
        properties = ModelTransform(modelName = "right_s_1_part2__aka_Server_UYDB_900")
    )
    (
        right_s_1_part2__union_895._out(0)
        >> [right_s_1_part2__aka_server_uydb_900._in(0), right_s_1_part2__aka_server_uydb_898._in(0)]
    )

...
with Pipeline(args) as pipeline:
    ...
    aka_server_uydb_1030 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1030.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1031 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1031.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1032 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1032.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1033 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1033.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1034 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1034.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1035 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1035.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1036 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1036.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1037 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1037.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1038 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1038.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1039 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1039.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1040 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1040.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1041 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1041.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1042 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1042.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1043 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1043.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1044 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1044.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1045 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1045.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1046 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1046.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1047 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1047.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1048 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1048.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1116 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1116.yml")
        ),
        input_ports = None
    )
    aka_server_uydb_1128 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/right_s_1_part1/aka_Server_UYDB_1128.yml")
        ),
        input_ports = None
    )
    intermediate_right_s_1_aka_server_uydb_1032 = Process(
        name = "intermediate_right_s_1_aka_Server_UYDB_1032",
        properties = Dataset(
    ...
    intermediate_right_s_1_aka_server_uydb_1033 = Process(
        name = "intermediate_right_s_1_aka_Server_UYDB_1033",
        properties = Dataset(
          table = Dataset.DBTSource(
            name = "intermediate_right_s_1_aka_Server_UYDB_1033",
            sourceType = "Table",
    ...
    intermediate_right_s_1_aka_server_uydb_1034 = Process(
        name = "intermediate_right_s_1_aka_Server_UYDB_1034",
        properties = Dataset(
          table = Dataset.DBTSource(
            name = "intermediate_right_s_1_aka_Server_UYDB_1034",
            sourceType = "Table",
    ...
    intermediate_right_s_1_aka_server_uydb_1035 = Process(
        name = "intermediate_right_s_1_aka_Server_UYDB_1035",
        properties = Dataset(
          table = Dataset.DBTSource(
            name = "intermediate_right_s_1_aka_Server_UYDB_1035",
            sourceType = "Table",
    ...
    intermediate_right_s_1_aka_server_uydb_1037 = Process(
        name = "intermediate_right_s_1_aka_Server_UYDB_1037",
        properties = Dataset(
          table = Dataset.DBTSource(
            name = "intermediate_right_s_1_aka_Server_UYDB_1037",
            sourceType = "Table",
    ...
    intermediate_right_s_1_aka_server_uydb_1038 = Process(
        name = "intermediate_right_s_1_aka_Server_UYDB_1038",
        properties = Dataset(
          table = Dataset.DBTSource(
            name = "intermediate_right_s_1_aka_Server_UYDB_1038",
            sourceType = "Table",
    ...
    intermediate_right_s_1_aka_server_uydb_1039 = Process(
        name = "intermediate_right_s_1_aka_Server_UYDB_1039",
        properties = Dataset(
          table = Dataset.DBTSource(
            name = "intermediate_right_s_1_aka_Server_UYDB_1039",
            sourceType = "Table",
    ...
    intermediate_right_s_1_aka_server_uydb_1040 = Process(
        name = "intermediate_right_s_1_aka_Server_UYDB_1040",
        properties = Dataset(
          table = Dataset.DBTSource(
            name = "intermediate_right_s_1_aka_Server_UYDB_1040",
            sourceType = "Table",
    ...
    intermediate_right_s_1_aka_server_uydb_1042 = Process(
        name = "intermediate_right_s_1_aka_Server_UYDB_1042",
        properties = Dataset(
          table = Dataset.DBTSource(
            name = "intermediate_right_s_1_aka_Server_UYDB_1042",
            sourceType = "Table",
    ...
    intermediate_right_s_1_aka_server_uydb_1044 = Process(
        name = "intermediate_right_s_1_aka_Server_UYDB_1044",
        properties = Dataset(
          table = Dataset.DBTSource(
            name = "intermediate_right_s_1_aka_Server_UYDB_1044",
            sourceType = "Table",
    ...
    intermediate_right_s_1_aka_server_uydb_1045 = Process(
        name = "intermediate_right_s_1_aka_Server_UYDB_1045",
        properties = Dataset(
          table = Dataset.DBTSource(
            name = "intermediate_right_s_1_aka_Server_UYDB_1045",
            sourceType = "Table",
    ...
    intermediate_right_s_1_aka_server_uydb_1047 = Process(
        name = "intermediate_right_s_1_aka_Server_UYDB_1047",
        properties = Dataset(
          table = Dataset.DBTSource(
            name = "intermediate_right_s_1_aka_Server_UYDB_1047",
            sourceType = "Table",
    ...
    intermediate_right_s_1_aka_server_uydb_1048 = Process(
        name = "intermediate_right_s_1_aka_Server_UYDB_1048",
        properties = Dataset(
          table = Dataset.DBTSource(
            name = "intermediate_right_s_1_aka_Server_UYDB_1048",
            sourceType = "Table",
    ...
    intermediate_right_s_1_aka_server_uydb_1116 = Process(
        name = "intermediate_right_s_1_aka_Server_UYDB_1116",
        properties = Dataset(
          table = Dataset.DBTSource(
            name = "intermediate_right_s_1_aka_Server_UYDB_1116",
            sourceType = "Table",
    ...
    intermediate_right_s_1_aka_server_uydb_1128 = Process(
        name = "intermediate_right_s_1_aka_Server_UYDB_1128",
        properties = Dataset(
          table = Dataset.DBTSource(
            name = "intermediate_right_s_1_aka_Server_UYDB_1128",
            sourceType = "Table",
    ...
    right_s_1_part1__filter_989 = Process(
        name = "right_s_1_part1__Filter_989",
        properties = ModelTransform(modelName = "right_s_1_part1__Filter_989")
    )
    right_s_1_part1__formula_990_0 = Process(
        name = "right_s_1_part1__Formula_990_0",
        properties = ModelTransform(modelName = "right_s_1_part1__Formula_990_0")
    )
    right_s_1_part1__formula_996_0 = Process(
        name = "right_s_1_part1__Formula_996_0",
        properties = ModelTransform(modelName = "right_s_1_part1__Formula_996_0")
    )
    right_s_1_part1__join_988_inner = Process(
        name = "right_s_1_part1__Join_988_inner",
        properties = ModelTransform(modelName = "right_s_1_part1__Join_988_inner"),
        input_ports = ["in_0", "in_1", "in_2", "in_3"]
    )
    right_s_1_part1__intermediate_right_s_1_alteryxselect_1012 = Process(
        name = "right_s_1_part1__intermediate_right_s_1_AlteryxSelect_1012",
        properties = ModelTransform(modelName = "right_s_1_part1__intermediate_right_s_1_AlteryxSelect_1012"),
        input_ports = ["in_0", "in_1", "in_2", "in_3", "in_4"]
    )
    right_s_1_part1__intermediate_right_s_1_alteryxselect_1025 = Process(
        name = "right_s_1_part1__intermediate_right_s_1_AlteryxSelect_1025",
        properties = ModelTransform(modelName = "right_s_1_part1__intermediate_right_s_1_AlteryxSelect_1025")
    )
    right_s_1_part1__intermediate_right_s_1_alteryxselect_1098 = Process(
        name = "right_s_1_part1__intermediate_right_s_1_AlteryxSelect_1098",
        properties = ModelTransform(modelName = "right_s_1_part1__intermediate_right_s_1_AlteryxSelect_1098"),
        input_ports = ["in_0", "in_1", "in_2"]
    )
    right_s_1_part1__intermediate_right_s_1_alteryxselect_1210 = Process(
        name = "right_s_1_part1__intermediate_right_s_1_AlteryxSelect_1210",
        properties = ModelTransform(modelName = "right_s_1_part1__intermediate_right_s_1_AlteryxSelect_1210")
    )
    right_s_1_part1__intermediate_right_s_1_alteryxselect_1241 = Process(
        name = "right_s_1_part1__intermediate_right_s_1_AlteryxSelect_1241",
        properties = ModelTransform(modelName = "right_s_1_part1__intermediate_right_s_1_AlteryxSelect_1241")
    )
    right_s_1_part1__intermediate_right_s_1_alteryxselect_1288 = Process(
        name = "right_s_1_part1__intermediate_right_s_1_AlteryxSelect_1288",
        properties = ModelTransform(modelName = "right_s_1_part1__intermediate_right_s_1_AlteryxSelect_1288"),
        input_ports = ["in_0", "in_1"]
    )
    right_s_1_part1__intermediate_right_s_1_alteryxselect_991 = Process(
        name = "right_s_1_part1__intermediate_right_s_1_AlteryxSelect_991",
        properties = ModelTransform(modelName = "right_s_1_part1__intermediate_right_s_1_AlteryxSelect_991")
    )
    right_s_1_part1__intermediate_right_s_1_alteryxselect_994 = Process(
        name = "right_s_1_part1__intermediate_right_s_1_AlteryxSelect_994",
        properties = ModelTransform(modelName = "right_s_1_part1__intermediate_right_s_1_AlteryxSelect_994")
    )
    right_s_1_part1__intermediate_right_s_1_alteryxselect_997 = Process(
        name = "right_s_1_part1__intermediate_right_s_1_AlteryxSelect_997",
        properties = ModelTransform(modelName = "right_s_1_part1__intermediate_right_s_1_AlteryxSelect_997")
    )
    right_s_1_part1__intermediate_right_s_1_formula_1161 = Process(
        name = "right_s_1_part1__intermediate_right_s_1_Formula_1161",
        properties = ModelTransform(modelName = "right_s_1_part1__intermediate_right_s_1_Formula_1161"),
        input_ports = ["in_0", "in_1"]
    )
    aka_server_uydb_1032 >> intermediate_right_s_1_aka_server_uydb_1032
    aka_server_uydb_1044 >> intermediate_right_s_1_aka_server_uydb_1044
    (
        right_s_1_part1__formula_990_0._out(0)
        >> [right_s_1_part1__intermediate_right_s_1_alteryxselect_1012._in(4),
              right_s_1_part1__intermediate_right_s_1_alteryxselect_991._in(0)]
    )
    aka_server_uydb_1042 >> intermediate_right_s_1_aka_server_uydb_1042
    aka_server_uydb_1039 >> intermediate_right_s_1_aka_server_uydb_1039
    aka_server_uydb_1047 >> intermediate_right_s_1_aka_server_uydb_1047
    (
        aka_server_uydb_1041._out(0)
        >> [right_s_1_part1__intermediate_right_s_1_alteryxselect_1098._in(0),
              right_s_1_part1__intermediate_right_s_1_alteryxselect_1098._in(1),
              right_s_1_part1__intermediate_right_s_1_alteryxselect_1098._in(2)]
    )
    aka_server_uydb_1046 >> right_s_1_part1__intermediate_right_s_1_alteryxselect_1241
    (
        right_s_1_part1__filter_989._out(0)
        >> [right_s_1_part1__intermediate_right_s_1_alteryxselect_994._in(0), right_s_1_part1__formula_990_0._in(0)]
    )
    (
        right_s_1_part1__formula_996_0._out(0)
        >> [right_s_1_part1__intermediate_right_s_1_alteryxselect_1012._in(3),
              right_s_1_part1__intermediate_right_s_1_alteryxselect_997._in(0)]
    )
    aka_server_uydb_1043 >> right_s_1_part1__intermediate_right_s_1_alteryxselect_1210
    aka_server_uydb_1031 >> right_s_1_part1__join_988_inner._in(3)
    aka_server_uydb_1034 >> intermediate_right_s_1_aka_server_uydb_1034
    aka_server_uydb_1040 >> intermediate_right_s_1_aka_server_uydb_1040
    aka_server_uydb_1030 >> right_s_1_part1__join_988_inner._in(0)
    (
        right_s_1_part1__join_988_inner._out(0)
        >> [right_s_1_part1__intermediate_right_s_1_alteryxselect_1012._in(0),
              right_s_1_part1__intermediate_right_s_1_alteryxselect_1012._in(1),
              right_s_1_part1__intermediate_right_s_1_alteryxselect_1012._in(2),
              right_s_1_part1__intermediate_right_s_1_alteryxselect_1025._in(0),
              right_s_1_part1__formula_996_0._in(0), right_s_1_part1__filter_989._in(0)]
    )
    aka_server_uydb_1038 >> intermediate_right_s_1_aka_server_uydb_1038
    (
        aka_server_uydb_1045._out(0)
        >> [intermediate_right_s_1_aka_server_uydb_1045._in(0), right_s_1_part1__join_988_inner._in(1)]
    )
    aka_server_uydb_1037 >> intermediate_right_s_1_aka_server_uydb_1037
    aka_server_uydb_1128 >> intermediate_right_s_1_aka_server_uydb_1128
    (
        aka_server_uydb_1116._out(0)
        >> [intermediate_right_s_1_aka_server_uydb_1116._in(0), right_s_1_part1__join_988_inner._in(2)]
    )
    aka_server_uydb_1033 >> intermediate_right_s_1_aka_server_uydb_1033
    aka_server_uydb_1035 >> intermediate_right_s_1_aka_server_uydb_1035
    aka_server_uydb_1048 >> intermediate_right_s_1_aka_server_uydb_1048
    (
        aka_server_uydb_1036._out(0)
        >> [right_s_1_part1__intermediate_right_s_1_alteryxselect_1288._in(0),
              right_s_1_part1__intermediate_right_s_1_alteryxselect_1288._in(1),
              right_s_1_part1__intermediate_right_s_1_formula_1161._in(0),
              right_s_1_part1__intermediate_right_s_1_formula_1161._in(1)]
    )

{{
  config({    
    "materialized": "table",
    "alias": "intermediate_right_s_1_AlteryxSelect_1012",
    "database": "tanmay",
    "schema": "default"
  })
}}
...
WITH Formula_996_0 AS (
  ...
  FROM {{ ref('right_s_1_part1__Formula_996_0')}}
...
Join_988_inner AS (
  ...
  FROM {{ ref('right_s_1_part1__Join_988_inner')}}
...
Formula_990_0 AS (
  ...
  FROM {{ ref('right_s_1_part1__Formula_990_0')}}

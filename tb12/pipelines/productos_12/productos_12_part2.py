...
with Pipeline(args) as pipeline:
    ...
    productos_12_part2__union_895 = Process(
        name = "productos_12_part2__Union_895",
        properties = ModelTransform(modelName = "productos_12_part2__Union_895"),
    ...
    productos_12_part2__aka_server_uydb_898 = Process(
        name = "productos_12_part2__aka_Server_UYDB_898",
        properties = ModelTransform(modelName = "productos_12_part2__aka_Server_UYDB_898")
    )
    productos_12_part2__aka_server_uydb_900 = Process(
        name = "productos_12_part2__aka_Server_UYDB_900",
        properties = ModelTransform(modelName = "productos_12_part2__aka_Server_UYDB_900")
    )
    (
        productos_12_part2__union_895._out(0)
        >> [productos_12_part2__aka_server_uydb_900._in(0), productos_12_part2__aka_server_uydb_898._in(0)]
    )

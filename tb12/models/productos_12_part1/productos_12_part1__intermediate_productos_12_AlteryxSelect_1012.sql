{{
  config({    
    "materialized": "table",
    "alias": "intermediate_productos_12_AlteryxSelect_1012",
    "database": "tanmay",
    "schema": "default"
  })
}}
...
WITH Formula_996_0 AS (
  ...
  FROM {{ ref('productos_12_part1__Formula_996_0')}}
...
Join_988_inner AS (
  ...
  FROM {{ ref('productos_12_part1__Join_988_inner')}}
...
Formula_990_0 AS (
  ...
  FROM {{ ref('productos_12_part1__Formula_990_0')}}

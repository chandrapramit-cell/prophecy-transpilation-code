...
WITH intermediate_productos_1_aka_Server_UYDB_1116 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_aka_Server_UYDB_1116') }}
...
Unique_1069 AS (
  ...
  FROM intermediate_productos_1_aka_Server_UYDB_1116 AS in0
...
intermediate_productos_1_aka_Server_UYDB_1128 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_aka_Server_UYDB_1128') }}
...
Filter_1083 AS (
  ...
  FROM intermediate_productos_1_aka_Server_UYDB_1128 AS in0
...
intermediate_productos_1_aka_Server_UYDB_1038 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_aka_Server_UYDB_1038') }}
...
Summarize_1185 AS (
  ...
  FROM intermediate_productos_1_aka_Server_UYDB_1038 AS in0
...
Join_1204_inner AS (
  ...
  INNER JOIN intermediate_productos_1_aka_Server_UYDB_1038 AS in1
...
intermediate_productos_1_aka_Server_UYDB_1035 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_aka_Server_UYDB_1035') }}
...
Filter_1181 AS (
  ...
  FROM intermediate_productos_1_aka_Server_UYDB_1035 AS in0
...
intermediate_productos_1_aka_Server_UYDB_1045 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_aka_Server_UYDB_1045') }}

),

intermediate_productos_1_aka_Server_UYDB_1037 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_aka_Server_UYDB_1037') }}
...
Join_1126_inner AS (
  ...
  FROM intermediate_productos_1_aka_Server_UYDB_1037 AS in0
  INNER JOIN intermediate_productos_1_aka_Server_UYDB_1045 AS in1
...
intermediate_productos_1_AlteryxSelect_1241 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_AlteryxSelect_1241') }}
...
Union_895_reformat_18 AS (
  ...
  FROM intermediate_productos_1_AlteryxSelect_1241 AS in0

),

intermediate_productos_1_aka_Server_UYDB_1039 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_aka_Server_UYDB_1039') }}
...
Summarize_1138 AS (
  ...
  FROM intermediate_productos_1_aka_Server_UYDB_1039 AS in0
...
intermediate_productos_1_aka_Server_UYDB_1042 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_aka_Server_UYDB_1042') }}
...
Summarize_1206 AS (
  ...
  FROM intermediate_productos_1_aka_Server_UYDB_1042 AS in0
...
intermediate_productos_1_aka_Server_UYDB_1032 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_aka_Server_UYDB_1032') }}

),

intermediate_productos_1_aka_Server_UYDB_1033 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_aka_Server_UYDB_1033') }}
...
Filter_1130 AS (
  ...
  FROM intermediate_productos_1_aka_Server_UYDB_1033 AS in0
...
Join_1133_inner AS (
  ...
  FROM intermediate_productos_1_aka_Server_UYDB_1032 AS in0
...
intermediate_productos_1_aka_Server_UYDB_1047 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_aka_Server_UYDB_1047') }}
...
Filter_1295 AS (
  ...
  FROM intermediate_productos_1_aka_Server_UYDB_1047 AS in0
  
  WHERE (activa = TRUE)

),

intermediate_productos_1_aka_Server_UYDB_1048 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_aka_Server_UYDB_1048') }}
...
AlteryxSelect_1300 AS (
  ...
  FROM intermediate_productos_1_aka_Server_UYDB_1048 AS in0
...
intermediate_productos_1_AlteryxSelect_994 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_AlteryxSelect_994') }}
...
intermediate_productos_1_aka_Server_UYDB_1034 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_aka_Server_UYDB_1034') }}
...
Filter_1151 AS (
  ...
  FROM intermediate_productos_1_aka_Server_UYDB_1034 AS in0
...
intermediate_productos_1_AlteryxSelect_1210 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_AlteryxSelect_1210') }}
...
Union_895_reformat_13 AS (
  ...
  FROM intermediate_productos_1_AlteryxSelect_1210 AS in0
...
Union_895_reformat_21 AS (
  ...
  FROM intermediate_productos_1_AlteryxSelect_994 AS in0
...
intermediate_productos_1_AlteryxSelect_1025 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_AlteryxSelect_1025') }}
...
Union_895_reformat_19 AS (
  ...
  FROM intermediate_productos_1_AlteryxSelect_1025 AS in0
...
intermediate_productos_1_aka_Server_UYDB_1044 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_aka_Server_UYDB_1044') }}
...
Formula_1233_0 AS (
  ...
  FROM intermediate_productos_1_aka_Server_UYDB_1044 AS in0
...
intermediate_productos_1_AlteryxSelect_1098 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_AlteryxSelect_1098') }}
...
Union_895_reformat_20 AS (
  ...
  FROM intermediate_productos_1_AlteryxSelect_1098 AS in0
...
intermediate_productos_1_AlteryxSelect_997 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_AlteryxSelect_997') }}
...
Union_895_reformat_14 AS (
  ...
  FROM intermediate_productos_1_AlteryxSelect_997 AS in0
...
intermediate_productos_1_aka_Server_UYDB_1040 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_aka_Server_UYDB_1040') }}
...
Filter_1148 AS (
  ...
  FROM intermediate_productos_1_aka_Server_UYDB_1040 AS in0
...
intermediate_productos_1_Formula_1161 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_Formula_1161') }}
...
Union_895_reformat_15 AS (
  ...
  FROM intermediate_productos_1_Formula_1161 AS in0
...
intermediate_productos_1_AlteryxSelect_1012 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_AlteryxSelect_1012') }}
...
Union_895_reformat_16 AS (
  ...
  FROM intermediate_productos_1_AlteryxSelect_1012 AS in0

),

intermediate_productos_1_AlteryxSelect_991 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_AlteryxSelect_991') }}
...
Union_895_reformat_17 AS (
  ...
  FROM intermediate_productos_1_AlteryxSelect_991 AS in0
...
intermediate_productos_1_AlteryxSelect_1288 AS (

  SELECT * 
  
  FROM {{ source('transpiled_sources', 'intermediate_productos_1_AlteryxSelect_1288') }}
...
Union_895_reformat_22 AS (
  ...
  FROM intermediate_productos_1_AlteryxSelect_1288 AS in0

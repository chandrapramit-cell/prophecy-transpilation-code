...
EXP_WORK_CARDS_ORIG_STAGING_reformat AS (
  ...
  SELECT 
    ...
    in_OFFERED_LIMIT_AMOUNT AS in_OFFERED_LIMIT_AMOUNT,
    MARKETING_PREFERENCES_PREFERRED_CHANNELS AS MARKETING_PREFERENCES_PREFERRED_CHANNELS,
    ANNUAL_INCOME_AMOUNT1 AS ANNUAL_INCOME_AMOUNT1,
    ...
    PRODUCT AS PRODUCT,
    in_CREDIT_DECISION_ANNUAL_PERCENTAGE_RATE AS in_CREDIT_DECISION_ANNUAL_PERCENTAGE_RATE,
    RESIDENTIAL_STATUS AS RESIDENTIAL_STATUS,
    in_CREDIT_DECISION_FINAL_CREDIT_LIMIT_OFFER AS in_CREDIT_DECISION_FINAL_CREDIT_LIMIT_OFFER,

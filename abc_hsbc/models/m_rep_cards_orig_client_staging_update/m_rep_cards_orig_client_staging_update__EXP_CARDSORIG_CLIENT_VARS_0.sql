...
SQ_CLIENT_GENERATE_SK_EXPR_39 AS (
...
EXP_GENERIC_NAME_REFORMAT_LOOKUP_merged AS (
  ...
  LEFT JOIN SQ_CLIENT_GENERATE_SK_EXPR_39 AS in1
     ON (
      (in0.class = 3000)
      AND (
            in0.value1 = upper(
...
EXP_CARDSORIG_CLIENT_JOIN_EXPR_36 AS (
...
EXP_CARDSORIG_CLIENT_LOOKUP_51 AS (
  ...
  LEFT JOIN EXP_CARDSORIG_CLIENT_JOIN_EXPR_36 AS in1
...
EXP_CARDSORIG_CLIENT_VARS_0 AS (
  ...
  FROM EXP_CARDSORIG_CLIENT_LOOKUP_51 AS in0

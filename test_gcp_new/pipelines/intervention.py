...
args = PipelineArgs(
    ...
    auto_layout = False,
    params = Parameters(
      username_Productioned_xl_1669 = "''",
      password_Productioned_xl_1669 = "''",
      username_Production_xlsx_1668 = "''",
      password_Production_xlsx_1668 = "''",
      workflow_name = "'intervention'"
    )
)
...
with Pipeline(args) as pipeline:
    ckd_risk_list_c_1675 = Process(
        ...
        properties = DatabricksVolumeSource(
          ...
          format = DatabricksVolumeSource.CsvReadFormat(schema = "external_sources/intervention/CKD_Risk_List_c_1675.yml")
        ),
        input_ports = None
    )
    edw_prod_csv_1664 = Process(
        ...
        properties = DatabricksVolumeSource(
          ...
          format = DatabricksVolumeSource.CsvReadFormat(schema = "external_sources/intervention/EDW_PROD_csv_1664.yml")
        ),
        input_ports = None
    )
    enrollment_expe_1672 = Process(
        ...
        properties = DatabricksVolumeSource(
          ...
          format = DatabricksVolumeSource.CsvReadFormat(schema = "external_sources/intervention/ENROLLMENT_EXPE_1672.yml")
        ),
        input_ports = None
    )
    hrhcreportlive__1679 = Process(
        ...
        properties = DatabricksVolumeSource(
          ...
          format = DatabricksVolumeSource.CsvReadFormat(schema = "external_sources/intervention/HRHCReportLive__1679.yml")
        ),
        input_ports = None
    )
    ...
    pcmh_csv_1671 = Process(
        ...
        properties = DatabricksVolumeSource(
          ...
          format = DatabricksVolumeSource.CsvReadFormat(schema = "external_sources/intervention/PCMH_csv_1671.yml")
        ),
        input_ports = None
    )
    past_120_rx_cou_1678 = Process(
        ...
        properties = DatabricksVolumeSource(
          ...
          format = DatabricksVolumeSource.CsvReadFormat(schema = "external_sources/intervention/Past_120_Rx_cou_1678.yml")
        ),
        input_ports = None
    )
    production_xlsx_1668 = Process(
        ...
        properties = DatabricksVolumeSource(
          ...
          format = DatabricksVolumeSource.XLSXReadFormat(
            ...
            schema = "external_sources/intervention/Production_xlsx_1668.yml",
    ...
    productioned_xl_1669 = Process(
        ...
        properties = DatabricksVolumeSource(
          ...
          format = DatabricksVolumeSource.XLSXReadFormat(
            allNullRowsPeekLimit = 10000,
            schema = "external_sources/intervention/Productioned_xl_1669.yml",
            allowAllNullRows = True,
            defaultColumnPrefix = "F"
          )
        ),
    ...
    providerdetailr_1661 = Process(
        ...
        properties = DatabricksVolumeSource(
          ...
          format = DatabricksVolumeSource.CsvReadFormat(schema = "external_sources/intervention/ProviderDetailR_1661.yml")
        ),
        input_ports = None
    )
    providerdetailr_1677 = Process(
        ...
        properties = DatabricksVolumeSource(
          ...
          format = DatabricksVolumeSource.CsvReadFormat(schema = "external_sources/intervention/ProviderDetailR_1677.yml")
        ),
        input_ports = None
    )
    total_inf_condi_1662 = Process(
        ...
        properties = DatabricksVolumeSource(
          ...
          format = DatabricksVolumeSource.CsvReadFormat(schema = "external_sources/intervention/TOTAL_INF_CONDI_1662.yml")
        ),
        input_ports = None
    )
    total_inf_condi_1674 = Process(
        ...
        properties = DatabricksVolumeSource(
          ...
          format = DatabricksVolumeSource.CsvReadFormat(schema = "external_sources/intervention/TOTAL_INF_CONDI_1674.yml")
        ),
        input_ports = None
    )
    total_inf_condi_1676 = Process(
        ...
        properties = DatabricksVolumeSource(
          ...
          format = DatabricksVolumeSource.CsvReadFormat(schema = "external_sources/intervention/TOTAL_INF_CONDI_1676.yml")
        ),
        input_ports = None
    )
    experianmappedt_1673 = Process(
        ...
        properties = DatabricksVolumeSource(
          ...
          format = DatabricksVolumeSource.CsvReadFormat(schema = "external_sources/intervention/experianMappedT_1673.yml")
        ),
        input_ports = None
    )
    ...
    selectdistinct__1663 = Process(
        ...
        properties = DatabricksVolumeSource(
          ...
          format = DatabricksVolumeSource.CsvReadFormat(schema = "external_sources/intervention/selectdistinct__1663.yml")
        ),
        input_ports = None
    )
    selectsum_csv_1667 = Process(
        ...
        properties = DatabricksVolumeSource(
          ...
          format = DatabricksVolumeSource.CsvReadFormat(schema = "external_sources/intervention/selectsum_csv_1667.yml")
        ),
        input_ports = None
    )
    vulnerability_s_1670 = Process(
        ...
        properties = DatabricksVolumeSource(
          ...
          format = DatabricksVolumeSource.CsvReadFormat(schema = "external_sources/intervention/vulnerability_s_1670.yml")
        ),
        input_ports = None
    )
    (

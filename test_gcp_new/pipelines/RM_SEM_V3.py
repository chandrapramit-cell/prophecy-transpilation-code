...
with Pipeline(args) as pipeline:
    ...
    rm_sem_v3__filter_288 = Process(
        name = "RM_SEM_V3__Filter_288",
        properties = ModelTransform(modelName = "RM_SEM_V3__Filter_288")
    )
    ...
    rm_sem_v3__multirowformula_440_row_id_0 = Process(
        name = "RM_SEM_V3__MultiRowFormula_440_row_id_0",
        properties = ModelTransform(modelName = "RM_SEM_V3__MultiRowFormula_440_row_id_0"),

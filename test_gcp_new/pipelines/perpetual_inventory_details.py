...
args = PipelineArgs(
    ...
    params = Parameters(
      ...
      Part_Number = "''",
      variable23_Expression = Expr("(Facility IN ({{ var('Select_Facilities_to_Include') }}))"),
...
with Pipeline(args) as pipeline:
    accountingtrans_98 = Process(
        ...
        properties = DatabricksVolumeSource(
          ...
          format = DatabricksVolumeSource.XLSXReadFormat(
            ...
            schema = "external_sources/perpetual_inventory_details/AccountingTrans_98.yml",
    ...
    textinput_26 = Process(
        ...
        properties = Dataset(
          ...
          table = Dataset.DBTSource(name = "seed_perpetual_inventory_details_26", sourceType = "Seed")
        ),
        input_ports = None
    )
    textinput_33 = Process(
        ...
        properties = Dataset(
          writeOptions = {"writeMode" : "overwrite"},
          table = Dataset.DBTSource(name = "seed_perpetual_inventory_details_33", sourceType = "Seed")
        ),
        input_ports = None
    )
    ...
    perpetual_inventory_details__perpetualinvent_105 = Process(
        name = "perpetual_inventory_details__PerpetualInvent_105",
        properties = ModelTransform(modelName = "perpetual_inventory_details__PerpetualInvent_105"),
        input_ports = ["in_0", "in_1", "in_2", "in_3", "in_4", "in_5"]
    )
    directory_11 >> perpetual_inventory_details__appendfields_16._in(0)
    dynamicinput_49 >> perpetual_inventory_details__perpetualinvent_105._in(2)
    perpetual_inventory_details__alteryxselect_48 >> dynamicinput_49
    accountingtrans_98 >> perpetual_inventory_details__perpetualinvent_105._in(4)
    dynamicinput_40 >> perpetual_inventory_details__perpetualinvent_105._in(1)
    dynamicinput_63 >> perpetual_inventory_details__perpetualinvent_105._in(3)
    (
        perpetual_inventory_details__formula_27_0._out(0)
        >> [perpetual_inventory_details__appendfields_16._in(1), perpetual_inventory_details__alteryxselect_39._in(0),
              perpetual_inventory_details__alteryxselect_48._in(0),
              perpetual_inventory_details__alteryxselect_62._in(1),
              perpetual_inventory_details__formula_29_0._in(0)]
    )
    samtecfacilitie_106 >> perpetual_inventory_details__perpetualinvent_105._in(0)
    textinput_33 >> perpetual_inventory_details__perpetualinvent_105._in(5)

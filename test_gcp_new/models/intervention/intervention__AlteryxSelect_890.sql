...
AlteryxSelect_887 AS (
  ...
  SELECT 
    ...
    CAST(Unique_Rx_Past_120 AS DOUBLE) AS UNIQUE_DRUG_CT_CURRENT_NEW
...
Unique_891_before AS (
  ...
  SELECT 
    `Person 1: Ethnic - Country Of Origin` AS `Person 1: Ethnic __ Country Of Origin`,
    `Person 1: Ethnic - Ethnic` AS `Person 1: Ethnic __ Ethnic`,
    `Person 1: Ethnic - Group` AS `Person 1: Ethnic __ Group`,
    `Person 1: Ethnic - Religion` AS `Person 1: Ethnic __ Religion`,
    `Person 1: Ethnic - Language Preference` AS `Person 1: Ethnic __ Language Preference`,
    `Person 1: Ethnic - Assimilation` AS `Person 1: Ethnic __ Assimilation`,
    * EXCEPT (`Person 1: Ethnic - Country Of Origin`, 
    `Person 1: Ethnic - Ethnic`, 
    `Person 1: Ethnic - Group`, 
    `Person 1: Ethnic - Religion`, 
    `Person 1: Ethnic - Language Preference`, 
    `Person 1: Ethnic - Assimilation`)
...
Unique_891 AS (
  ...
  MAX_ROW_EFF_DT, 
  MATCHLEVEL, 
  `Person 1: Ethnic __ Country Of Origin`, 
  `Person 1: Ethnic __ Ethnic`, 
  `Person 1: Ethnic __ Group`, 
  `Person 1: Ethnic __ Religion`, 
  `Person 1: Ethnic __ Language Preference`, 
  `Person 1: Ethnic __ Assimilation`, 
  est_hh_income, 
  est_hh_income_range, 
...
Unique_891_after AS (
  ...
  SELECT 
    `Person 1: Ethnic __ Country Of Origin` AS `Person 1: Ethnic - Country Of Origin`,
    `Person 1: Ethnic __ Ethnic` AS `Person 1: Ethnic - Ethnic`,
    `Person 1: Ethnic __ Group` AS `Person 1: Ethnic - Group`,
    `Person 1: Ethnic __ Religion` AS `Person 1: Ethnic - Religion`,
    `Person 1: Ethnic __ Language Preference` AS `Person 1: Ethnic - Language Preference`,
    `Person 1: Ethnic __ Assimilation` AS `Person 1: Ethnic - Assimilation`,
    * EXCEPT (`Person 1: Ethnic __ Country Of Origin`, 
    `Person 1: Ethnic __ Ethnic`, 
    `Person 1: Ethnic __ Group`, 
    `Person 1: Ethnic __ Religion`, 
    `Person 1: Ethnic __ Language Preference`, 
...
Cleanse_892 AS (
  ...
  {{
    prophecy_basics.DataCleansing(
      ['Unique_891_after'], 
      [
        { "name": "Person 1: Ethnic - Country Of Origin", "dataType": "String" }, 
        { "name": "Person 1: Ethnic - Ethnic", "dataType": "String" }, 
        { "name": "Person 1: Ethnic - Group", "dataType": "String" }, 
        { "name": "Person 1: Ethnic - Religion", "dataType": "String" }, 
        { "name": "Person 1: Ethnic - Language Preference", "dataType": "String" }, 
        { "name": "Person 1: Ethnic - Assimilation", "dataType": "String" }, 
        ...
        { "name": "_Null_", "dataType": "Integer" }, 
        { "name": "Asthma", "dataType": "Integer" }, 
        { "name": "CAD", "dataType": "Integer" }, 
        { "name": "Cancer", "dataType": "Integer" }, 
        { "name": "CHF", "dataType": "Integer" }, 
        { "name": "COPD", "dataType": "Integer" }, 
        { "name": "Diabetes", "dataType": "Integer" }, 
        { "name": "ESRD", "dataType": "Double" }, 
        { "name": "Hypertension", "dataType": "Integer" }, 
        ...
        { "name": "Other_Chronic_Conditions", "dataType": "Integer" }, 
        { "name": "Non_Chronic_Condition", "dataType": "Integer" }, 
        { "name": "Population", "dataType": "Integer" }, 
        { "name": "Breathing_Conditions", "dataType": "Integer" }, 
        { "name": "Right_Inflected Indicator Pred", "dataType": "String" }, 
        { "name": "Transplant", "dataType": "Integer" }, 
        { "name": "Digestive_System_Disorders", "dataType": "Integer" }, 
        { "name": "Unknown", "dataType": "Integer" }, 
        { "name": "Mental_Health", "dataType": "Integer" }, 
        { "name": "Comprehensive Risk Score", "dataType": "Integer" }, 
        { "name": "Right_AVG_12_MONTH_BIN_PRED", "dataType": "String" }, 
        { "name": "Developmental_Delays__ADHD__Autism", "dataType": "Integer" }, 
        { "name": "Heart_and_Blood_Vessel_Conditions", "dataType": "Integer" }, 
        { "name": "Renal_Failure__Chronic__ESRD", "dataType": "Integer" }, 
        { "name": "Likelihood Factor", "dataType": "Integer" }, 
        { "name": "Right_Inflection Index Pred", "dataType": "String" }, 
        { "name": "Pulmonary_Hypertension", "dataType": "Integer" }, 
        { "name": "Muscle__Bone___Joint_Conditions", "dataType": "Integer" }, 
...
Formula_889_0 AS (
  ...
  SELECT 
    CAST((
      ...
      END
    ) AS DOUBLE) AS UNIQUE_DRUG_CT_CURRENT,

...
Join_815_inner AS (
  ...
  SELECT 
    ...
    in0.`Person 1: Ethnic - Country Of Origin` AS `Person 1: Ethnic - Country Of Origin`,
    in0.`Person 1: Ethnic - Assimilation` AS `Person 1: Ethnic - Assimilation`,
    1 AS Other_Chronic_Conditions,
    ...
    1 AS Breathing_Conditions,
    in0.PRNT_GRP_SIC_NACIS_NM AS PRNT_GRP_SIC_NACIS_NM,
    in0.`Person 1: Ethnic - Group` AS `Person 1: Ethnic - Group`,
    in0.COPD AS COPD,
    ...
    1 AS Digestive_System_Disorders,
    ...
    1 AS Developmental_Delays__ADHD__Autism,
    ...
    in0.`Person 1: Ethnic - Ethnic` AS `Person 1: Ethnic - Ethnic`,
    ...
    1 AS Heart_and_Blood_Vessel_Conditions,
    in0.READMIN_DSCHG_DT AS READMIN_DSCHG_DT,
    in0.`Person 1: Ethnic - Religion` AS `Person 1: Ethnic - Religion`,
    in0.NONEMERGENT_COUNT_PAST_60 AS NONEMERGENT_COUNT_PAST_60,
    in0.`Person 1: Ethnic - Language Preference` AS `Person 1: Ethnic - Language Preference`,
    1 AS Renal_Failure__Chronic__ESRD,
    in0.PROV_SK AS PROV_SK,
    in0.`Inflection Index Pred` AS `Inflection Index Pred`,
    1 AS `Likelihood Factor`,
    ...
    1 AS Muscle__Bone___Joint_Conditions,

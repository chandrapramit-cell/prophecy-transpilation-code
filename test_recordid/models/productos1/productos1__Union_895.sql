...
WITH aka_Server_UYDB_1034 AS (

  SELECT *
  
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1034') }}
...
aka_Server_UYDB_1043 AS (

  SELECT *
  
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1043') }}
...
aka_Server_UYDB_1038 AS (
  ...
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1038') }}
...
aka_Server_UYDB_1116 AS (
  ...
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1116') }}
...
aka_Server_UYDB_1045 AS (
  ...
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1045') }}
...
aka_Server_UYDB_1031 AS (
  ...
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1031') }}
...
aka_Server_UYDB_1030 AS (
  ...
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1030') }}
...
aka_Server_UYDB_1128 AS (
  ...
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1128') }}
...
aka_Server_UYDB_1040 AS (
  ...
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1040') }}
...
aka_Server_UYDB_1036 AS (
  ...
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1036') }}
...
aka_Server_UYDB_1037 AS (
  ...
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1037') }}
...
aka_Server_UYDB_1033 AS (
  ...
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1033') }}
...
aka_Server_UYDB_1046 AS (
  ...
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1046') }}
...
aka_Server_UYDB_1042 AS (
  ...
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1042') }}
...
aka_Server_UYDB_1032 AS (
  ...
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1032') }}
...
aka_Server_UYDB_1047 AS (
  ...
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1047') }}
...
aka_Server_UYDB_1048 AS (
  ...
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1048') }}
...
aka_Server_UYDB_1041 AS (
  ...
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1041') }}
...
aka_Server_UYDB_1035 AS (
  ...
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1035') }}
...
aka_Server_UYDB_1044 AS (
  ...
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1044') }}
...
aka_Server_UYDB_1039 AS (
  ...
  FROM {{ prophecy_tmp_source('productos1', 'aka_Server_UYDB_1039') }}

...
WITH aka_Server_UYDB_1043 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1043') }}
...
Sample_1220 AS (
  ...
  {#VisualGroup: PagodeImpuestosProd33#}
  {{ prophecy_basics.Sample('Summarize_1218', [], 1002, 'firstN', 13) }}
...
DynamicRename_1212 AS (
  ...
  {{
    prophecy_basics.MultiColumnRename(
      ...
      ['12', '8', '4', '11', '9', '13', '5', '10', '6', '14', '2', '7', '3'], 
      'editPrefixSuffix', 
      ['idf_pers_ods', 'TipoPago', '12', '8', '4', '11', '9', '13', '5', '10', '6', '14', '2', '7', '3'], 
      'Prefix', 
      'Col', 
      ""
    )
...
aka_Server_UYDB_1116 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1116') }}
...
aka_Server_UYDB_1045 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1045') }}
...
aka_Server_UYDB_1031 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1031') }}
...
aka_Server_UYDB_1030 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1030') }}
...
aka_Server_UYDB_1037 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1037') }}
...
aka_Server_UYDB_1047 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1047') }}
...
aka_Server_UYDB_1048 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1048') }}
...
aka_Server_UYDB_1128 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1128') }}
...
aka_Server_UYDB_1041 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1041') }}
...
Sample_1104 AS (
  ...
  {#VisualGroup: TPVProd19#}
  {{ prophecy_basics.Sample('Summarize_1102', [], 1002, 'firstN', 17) }}
...
MultiFieldFormula_1099 AS (
  ...
  {{
    prophecy_basics.MultiColumnEdit(
      ...
      ['monto_arbitrado_dolares', 'AAAAMM', 'idf_pers_ods', 'merchant', 'MesId'], 
...
aka_Server_UYDB_1038 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1038') }}
...
aka_Server_UYDB_1036 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1036') }}
...
Sample_1168 AS (
  ...
  {#VisualGroup: CobrodeSueldosProd9#}
  {{ prophecy_basics.Sample('Summarize_1166', [], 1002, 'firstN', 17) }}
...
aka_Server_UYDB_1033 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1033') }}
...
aka_Server_UYDB_1035 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1035') }}
...
aka_Server_UYDB_1042 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1042') }}
...
aka_Server_UYDB_1032 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1032') }}
...
aka_Server_UYDB_1034 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1034') }}
...
aka_Server_UYDB_1046 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1046') }}
...
aka_Server_UYDB_1040 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1040') }}
...
aka_Server_UYDB_1039 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1039') }}
...
aka_Server_UYDB_1044 AS (
  ...
  FROM {{ prophecy_tmp_source('productos', 'aka_Server_UYDB_1044') }}

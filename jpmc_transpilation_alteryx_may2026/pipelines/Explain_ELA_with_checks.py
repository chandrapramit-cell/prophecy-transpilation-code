...
with Pipeline(args) as pipeline:
    ...
    counterparty_cv_28 = Process(
        ...
        properties = SFTPSource(
          ...
          format = SFTPSource.XLSXReadFormat(schema = "external_sources/Explain_ELA_with_checks/Counterparty_CV_28.yml")
        ),
        input_ports = None
    )
    counterparty_cv_29 = Process(
        ...
        properties = SFTPSource(
          ...
          format = SFTPSource.XLSXReadFormat(schema = "external_sources/Explain_ELA_with_checks/Counterparty_CV_29.yml")
        ),
        input_ports = None
    )
    ...
    elacalibration2_20 = Process(
        ...
        properties = SFTPSource(
          ...
          format = SFTPSource.XLSXReadFormat(schema = "external_sources/Explain_ELA_with_checks/ELACalibration2_20.yml")
        ),
        input_ports = None
    )
    ela_results_202_16 = Process(
        ...
        properties = SFTPSource(
          ...
          format = SFTPSource.XLSXReadFormat(schema = "external_sources/Explain_ELA_with_checks/ELA_results_202_16.yml")
        ),
        input_ports = None
    )
    ...
    bd_27_feb_2026__42 = Process(
        ...
        properties = SFTPSource(
          ...
          format = SFTPSource.CsvReadFormat(schema = "external_sources/Explain_ELA_with_checks/bd_27_Feb_2026__42.yml")
        ),
        input_ports = None
    )
    bd_27_feb_2026__53 = Process(
        ...
        properties = SFTPSource(
          ...
          format = SFTPSource.CsvReadFormat(schema = "external_sources/Explain_ELA_with_checks/bd_27_Feb_2026__53.yml")
        ),
        input_ports = None
    )
    bd_30_jan_2026__47 = Process(
        ...
        properties = SFTPSource(
          ...
          format = SFTPSource.CsvReadFormat(schema = "external_sources/Explain_ELA_with_checks/bd_30_Jan_2026__47.yml")
        ),
        input_ports = None
    )
    ...
    (
        ...
        >> [explain_ela_with_checks__alteryxselect_81._in(0), explain_ela_with_checks__formula_60_2._in(0)]
    )

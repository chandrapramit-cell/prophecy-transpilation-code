...
with Pipeline(args) as pipeline:
    barreport_apac__1 = Process(
        ...
        properties = SFTPSource(
          ...
          format = SFTPSource.CsvReadFormat(schema = "external_sources/Barrier_Bend_Monitoring_1_/BarReport_APAC__1.yml")
        ),
        input_ports = None
    )
    ...
    barrierbendingm_5 = Process(
        ...
        properties = SFTPSource(
          ...
          format = SFTPSource.XLSXReadFormat(schema = "external_sources/Barrier_Bend_Monitoring_1_/BarrierBendingM_5.yml")
        ),
        input_ports = None
    )
    ...
    barrier_bend_monitoring_1___alteryxselect_84 = Process(
        name = "Barrier_Bend_Monitoring_1___AlteryxSelect_84",
        properties = ModelTransform(modelName = "Barrier_Bend_Monitoring_1___AlteryxSelect_84"),
    ...
    barrier_bend_monitoring_1___portfoliocomposertable_98 = Process(
        name = "Barrier_Bend_Monitoring_1___PortfolioComposerTable_98",
        properties = ModelTransform(modelName = "Barrier_Bend_Monitoring_1___PortfolioComposerTable_98")
    )
    smartbendingrep_64 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/Barrier_Bend_Monitoring_1_/SmartBendingRep_64.yml")
        ),
        input_ports = None
    )
    smartbendingrep_67 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/Barrier_Bend_Monitoring_1_/SmartBendingRep_67.yml")
        ),
        input_ports = None
    )
    smartbendingrep_79 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/Barrier_Bend_Monitoring_1_/SmartBendingRep_79.yml")
        ),
        input_ports = None
    )
    textinput_9 = Process(
    ...
    smartbendingrep_79 >> barrier_bend_monitoring_1___alteryxselect_80
    (
        barrier_bend_monitoring_1___formula_85_0._out(0)
        >> [barrierbendingm_102._in(0), barrier_bend_monitoring_1___alteryxselect_84._in(1),
              barrier_bend_monitoring_1___alteryxselect_84._in(2)]
    )
    (
        barrier_bend_monitoring_1___alteryxselect_84._out(0)
        >> [barrierbendingm_74._in(0), barrier_bend_monitoring_1___portfoliocomposertable_98._in(0)]
    )
    (
        barrier_bend_monitoring_1___formula_72_3._out(0)
        >> [barrierbendingm_73._in(0), barrier_bend_monitoring_1___formula_85_0._in(5)]
    )
    smartbendingrep_67 >> barrier_bend_monitoring_1___formula_72_3._in(1)
    (
        barreport_apac__1._out(0)
        >> [barrier_bend_monitoring_1___alteryxselect_84._in(0), barrier_bend_monitoring_1___formula_85_0._in(0),
              barrier_bend_monitoring_1___formula_85_0._in(1),
              barrier_bend_monitoring_1___formula_85_0._in(2)]
    )
    barrierbendingm_5 >> barrier_bend_monitoring_1___formula_85_0._in(3)
    smartbendingrep_64 >> barrier_bend_monitoring_1___formula_72_3._in(0)

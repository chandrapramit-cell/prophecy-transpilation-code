...
with Pipeline(args) as pipeline:
    ...
    with visual_group("MoveandArchiveFilesmszurichcomau"):
        with visual_group("CMD"):
            pass

    with visual_group("ReadDirectory"):

        with visual_group("Checkanyfilestoread"):
            pass

        with visual_group("J0directory"):
            pass

        with visual_group("J1directory"):
            pass

    with visual_group("Sendemail"):
        pass

    with visual_group("TransformationandHKF"):
        with visual_group("SnowflakeAppend"):
            pass

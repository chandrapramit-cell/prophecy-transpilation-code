...
with Pipeline(args) as pipeline:
    ...
    claim_cache_csv_191 = Process(
        name = "claim_cache_csv_191",
        properties = SFTPSource(
          ...
          properties = SFTPSource.SFTPSourceInternal(
            filePath = "O:\\library\\Alteryx\\Advanced Analytics\\Jon Sands\\CHS Transfer\\MVP Cache\\claim_cache.csv"
          ),
          format = SFTPSource.CsvReadFormat(schema = "external_sources/Health_Buckets_MVP_Priority_2/claim_cache_csv_191.yml")
        ),
        input_ports = None
    )
    ...
    health_buckets_mvp_priority_2__filter_189 = Process(
        name = "Health_Buckets_MVP_Priority_2__Filter_189",
        properties = ModelTransform(modelName = "Health_Buckets_MVP_Priority_2__Filter_189"),
        input_ports = ["in_0", "in_1"]
    )
    ...
    health_bucket_c_118 = Process(
        name = "Health_Bucket_c_118",
        properties = SFTPTarget(
          ...
          properties = SFTPTarget.SFTPTargetInternal(
            filePath = "O:\\library\\Alteryx\\Advanced Analytics\\Jon Sands\\CHS Transfer\\MVP Cache\\Health_Bucket.csv"
          ),
          format = SFTPTarget.CsvWriteFormat()
        )
    )
    total_inf_predi_171 = Process(
        name = "TOTAL_INF_predi_171",
        properties = SFTPSource(
          connector = {
            "kind": "sftp",
            "id": "transpiled_connection",
          ...
          properties = SFTPSource.SFTPSourceInternal(
            filePath = "O:\\library\\Alteryx\\Advanced Analytics\\Jon Sands\\CHS Transfer\\MVP Cache\\TOTAL_INF_predicted.csv"
          ),
          format = SFTPSource.CsvReadFormat(schema = "external_sources/Health_Buckets_MVP_Priority_2/TOTAL_INF_predi_171.yml")
        ),
        input_ports = None
    )
    ...
    active_members__172 = Process(
        name = "active_members__172",
        properties = SFTPSource(
          connector = {
            "kind": "sftp",
            "id": "transpiled_connection",
          ...
          properties = SFTPSource.SFTPSourceInternal(
            filePath = "O:\\library\\Alteryx\\Advanced Analytics\\Jon Sands\\CHS Transfer\\MVP Cache\\active_members.csv"
          ),
          format = SFTPSource.CsvReadFormat(schema = "external_sources/Health_Buckets_MVP_Priority_2/active_members__172.yml")
        ),
        input_ports = None
    )
    (
        total_inf_predi_171._out(0)
        >> [health_buckets_mvp_priority_2__sort_125._in(3), health_buckets_mvp_priority_2__summarize_173._in(0)]
    )
    (
    ...
    health_buckets_mvp_priority_2__filter_189 >> health_bucket_c_118
    (
    ...
    claim_cache_csv_191 >> health_buckets_mvp_priority_2__sort_125._in(2)
    health_buckets_mvp_priority_2__formula_127_0 >> generaterows_128
    (
        health_buckets_mvp_priority_2__formula_159_0._out(0)
        >> [health_buckets_mvp_priority_2__crosstab_151._in(1), health_buckets_mvp_priority_2__filter_189._in(1)]
    )
    ...
    (
        ...
        >> [health_buckets_mvp_priority_2__sort_141._in(2), health_buckets_mvp_priority_2__formula_159_0._in(2),
    ...
    active_members__172 >> health_buckets_mvp_priority_2__sort_125._in(0)
    (
    ...
    (
        ...
        >> [health_buckets_mvp_priority_2__crosstab_151._in(0), health_buckets_mvp_priority_2__filter_189._in(0),

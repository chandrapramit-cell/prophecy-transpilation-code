...
WITH Configuration_t_58 AS (
  ...
  FROM {{ prophecy_tmp_source('CEM_Securities_PruVal_6m_Trade_Volume_Upload_v_1_0_1_1', 'Configuration_t_58') }}
...
Formula_73_0 AS (
  ...
  SELECT 
    CAST(((ABS_Notional * Weights) / `Number of working Days`) AS DOUBLE) AS Weighted_Sum,
    *

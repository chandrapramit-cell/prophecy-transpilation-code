...
MultiRowFormula_2831_row_id_0 AS (

  SELECT 
    RecordID AS prophecy_row_id,
    *
  
  FROM RecordID_2830 AS in0

),

MultiRowFormula_2831_0 AS (
  ...
  FROM MultiRowFormula_2831_row_id_0 AS in0

),

MultiRowFormula_2831_1 AS (
  ...
  FROM MultiRowFormula_2831_0 AS in0

),

MultiRowFormula_2831_row_id_drop_0 AS (

  SELECT * EXCEPT (`prophecy_row_id`)
  
  FROM MultiRowFormula_2831_1 AS in0

),

AlteryxSelect_2833 AS (

  SELECT 
    CAST(RecordID AS string) AS RecordID,
    * EXCEPT (`RecordID`)
  
  FROM MultiRowFormula_2831_row_id_drop_0 AS in0
...
Formula_2832_0 AS (
  ...
  FROM AlteryxSelect_2833 AS in0
...
AlteryxSelect_2834 AS (
  ...
  FROM Formula_2832_0 AS in0

)

SELECT *

FROM AlteryxSelect_2834

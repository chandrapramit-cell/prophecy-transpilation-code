...
Union_1837 AS (
  ...
  {{
    prophecy_basics.UnionByName(
      ...
      [
        '[{"name": "ACV", "dataType": "Double"}, {"name": "TCV", "dataType": "Double"}, {"name": "Quantity", "dataType": "Double"}, {"name": "Actual Closed Date", "dataType": "Date"}, {"name": "Order: End Date (Calculated)", "dataType": "Date"}, {"name": "Order: Sales Order Number", "dataType": "String"}, {"name": "Created Date", "dataType": "Date"}, {"name": "StartDate_Annualization", "dataType": "Date"}, {"name": "Origin", "dataType": "String"}, {"name": "Order: Start Date", "dataType": "Date"}, {"name": "Mas90 Customer Number", "dataType": "String"}, {"name": "Expected Renewal Date", "dataType": "Date"}, {"name": "Product Code", "dataType": "String"}, {"name": "Product", "dataType": "String"}, {"name": "Stage", "dataType": "String"}, {"name": "EndDate_Annualization", "dataType": "Date"}]', 
        '[{"name": "EndDate_Annualization", "dataType": "Date"}, {"name": "TCV", "dataType": "Double"}, {"name": "Origin", "dataType": "String"}, {"name": "Actual Closed Date", "dataType": "Date"}, {"name": "Stage", "dataType": "String"}, {"name": "StartDate_Annualization", "dataType": "Date"}, {"name": "Product", "dataType": "String"}, {"name": "Mas90 Customer Number", "dataType": "String"}]'
      ], 
      'allowMissingColumns'
    )
  }}

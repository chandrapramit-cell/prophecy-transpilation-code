...
Union_1980 AS (
  ...
  {{
    prophecy_basics.UnionByName(
      ...
      [
        '[{"name": "RevMonth", "dataType": "Date"}, {"name": "MRR", "dataType": "Double"}, {"name": "ARR", "dataType": "Double"}, {"name": "Product", "dataType": "String"}, {"name": "Quantity", "dataType": "Double"}, {"name": "StaticHistoryYearEnd", "dataType": "String"}, {"name": "YetToRenewARR", "dataType": "Double"}, {"name": "Sector", "dataType": "String"}, {"name": "Territory Name", "dataType": "String"}, {"name": "CustomerName", "dataType": "String"}, {"name": "Account Size", "dataType": "String"}, {"name": "Account Owner", "dataType": "String"}, {"name": "State", "dataType": "String"}, {"name": "Partner Success Owner", "dataType": "String"}, {"name": "variableType", "dataType": "String"}]', 
        '[{"name": "ARR", "dataType": "Double"}, {"name": "Quantity", "dataType": "Double"}, {"name": "MRR", "dataType": "Double"}, {"name": "StaticHistoryYearEnd", "dataType": "Date"}, {"name": "Sector", "dataType": "String"}, {"name": "Territory Name", "dataType": "String"}, {"name": "CustomerName", "dataType": "String"}, {"name": "RevMonth", "dataType": "Date"}, {"name": "MaxIteration", "dataType": "Double"}, {"name": "Account Size", "dataType": "String"}, {"name": "StaticHistoryMonth", "dataType": "Date"}, {"name": "Account Owner", "dataType": "String"}, {"name": "Product", "dataType": "String"}, {"name": "State", "dataType": "String"}, {"name": "Partner Success Owner", "dataType": "String"}, {"name": "variableType", "dataType": "String"}, {"name": "YetToRenewARR", "dataType": "Double"}, {"name": "ChangeLog", "dataType": "String"}, {"name": "Output Name", "dataType": "String"}]'
      ], 
      'allowMissingColumns'
    )
  }}

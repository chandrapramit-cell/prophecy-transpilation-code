...
Union_1045 AS (
  ...
  {{
    prophecy_basics.UnionByName(
      ...
      [
        '[{"name": "Orders Quantity", "dataType": "Decimal(38, 9)"}, {"name": "Product Code", "dataType": "String"}, {"name": "TCV", "dataType": "Double"}, {"name": "Origin", "dataType": "String"}, {"name": "Engine_ContractDays", "dataType": "Double"}, {"name": "EndDate_Annualization", "dataType": "Date"}, {"name": "ACV", "dataType": "Double"}, {"name": "StartDate_Annualization", "dataType": "Date"}, {"name": "Right_Quantity", "dataType": "Double"}, {"name": "Orders ACV", "dataType": "Double"}, {"name": "Original_EndDate_Annualization", "dataType": "Date"}, {"name": "Account Name: Mas90 Customer Number", "dataType": "String"}, {"name": "Primary Quote: End Date (Calculated)", "dataType": "Date"}, {"name": "Primary Quote: Start Date", "dataType": "Date"}, {"name": "Product", "dataType": "String"}, {"name": "Opportunity Name", "dataType": "String"}, {"name": "Stage", "dataType": "String"}, {"name": "Renewed Contract: Contract Number", "dataType": "String"}, {"name": "Actual Closed Date", "dataType": "Date"}, {"name": "Expected Renewal Date", "dataType": "Date"}, {"name": "Created Date", "dataType": "Date"}, {"name": "Renewed Contract: Order: Sales Order Number", "dataType": "String"}, {"name": "Left_Left_Account Name: Mas90 Customer Number", "dataType": "String"}]', 
        '[{"name": "TCV", "dataType": "Double"}, {"name": "Origin", "dataType": "String"}, {"name": "Engine_ContractDays", "dataType": "Double"}, {"name": "EndDate_Annualization", "dataType": "Date"}, {"name": "ACV", "dataType": "Double"}, {"name": "StartDate_Annualization", "dataType": "Date"}, {"name": "Orders ACV", "dataType": "Double"}, {"name": "Orders Quantity", "dataType": "Decimal(29, 9)"}, {"name": "Original_EndDate_Annualization", "dataType": "Date"}, {"name": "Account Name: Mas90 Customer Number", "dataType": "String"}, {"name": "Primary Quote: End Date (Calculated)", "dataType": "Date"}, {"name": "Primary Quote: Start Date", "dataType": "Date"}, {"name": "Product", "dataType": "String"}, {"name": "Product Code", "dataType": "String"}, {"name": "Renewed Contract: Order: Sales Order Number", "dataType": "String"}, {"name": "Opportunity Name", "dataType": "String"}, {"name": "Stage", "dataType": "String"}, {"name": "Renewed Contract: Contract Number", "dataType": "String"}, {"name": "Quantity", "dataType": "Double"}, {"name": "Expected Renewal Date", "dataType": "Date"}, {"name": "Actual Closed Date", "dataType": "Date"}, {"name": "Created Date", "dataType": "Date"}, {"name": "Left_Left_Account Name: Mas90 Customer Number", "dataType": "String"}]'
      ], 
      'allowMissingColumns'
    )
  }}

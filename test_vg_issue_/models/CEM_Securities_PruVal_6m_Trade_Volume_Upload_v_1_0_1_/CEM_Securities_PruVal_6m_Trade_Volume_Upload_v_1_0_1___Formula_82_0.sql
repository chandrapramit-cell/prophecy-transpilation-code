...
WITH Directory_78 AS (

  SELECT *
  
  FROM {{ prophecy_tmp_source('CEM_Securities_PruVal_6m_Trade_Volume_Upload_v_1_0_1_', 'Directory_78') }}

),

Directory_78_reformat AS (
...
AlteryxSelect_77 AS (
  ...
  FROM Directory_78_reformat AS in0

...
with Pipeline(args) as pipeline:
    database__loadi_280 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/RM_SEM_V3/Database__LOADI_280.yml")
        ),
        input_ports = None
    )
    database__loadi_283 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/RM_SEM_V3/Database__LOADI_283.yml")
        ),
        input_ports = None
    )
    database__loadi_292 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/RM_SEM_V3/Database__LOADI_292.yml")
        ),
        input_ports = None
    )
    database__loadi_313 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/RM_SEM_V3/Database__LOADI_313.yml")
        ),
        input_ports = None
    )
    database__loadi_330 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/RM_SEM_V3/Database__LOADI_330.yml")
        ),
        input_ports = None
    )
    database__loadi_341 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/RM_SEM_V3/Database__LOADI_341.yml")
        ),
        input_ports = None
    )
    database__loadi_363 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/RM_SEM_V3/Database__LOADI_363.yml")
        ),
        input_ports = None
    )
    database__loadi_394 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/RM_SEM_V3/Database__LOADI_394.yml")
        ),
        input_ports = None
    )
    database__loadi_395 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/RM_SEM_V3/Database__LOADI_395.yml")
        ),
        input_ports = None
    )
    database__loadi_403 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/RM_SEM_V3/Database__LOADI_403.yml")
        ),
        input_ports = None
    )
    database__repor_351 = Process(
        ...
        properties = OracleSource(
          ...
          format = OracleSource.OracleReadFormat(schema = "external_sources/RM_SEM_V3/Database__REPOR_351.yml")
        ),
        input_ports = None
    )
    rm_sem_v3__alteryxselect_338 = Process(
        name = "RM_SEM_V3__AlteryxSelect_338",
        properties = ModelTransform(modelName = "RM_SEM_V3__AlteryxSelect_338"),
        input_ports = ["in_0", "in_1", "in_2", "in_3", "in_4", "in_5"]
    )
    rm_sem_v3__formula_321_0 = Process(
        name = "RM_SEM_V3__Formula_321_0",
        properties = ModelTransform(modelName = "RM_SEM_V3__Formula_321_0")
    )
    rm_sem_v3__join_311_left_unionleftouter = Process(
        name = "RM_SEM_V3__Join_311_left_UnionLeftOuter",
        properties = ModelTransform(modelName = "RM_SEM_V3__Join_311_left_UnionLeftOuter"),
        input_ports = ["in_0", "in_1", "in_2", "in_3", "in_4", "in_5", "in_6", "in_7", "in_8", "in_9", "in_10", "in_11", "in_12",
         "in_13"]
    )
    rm_sem_v3__join_329_inner = Process(
        name = "RM_SEM_V3__Join_329_inner",
        properties = ModelTransform(modelName = "RM_SEM_V3__Join_329_inner"),
        input_ports = ["in_0", "in_1"]
    )
    rm_sem_v3__join_373_inner = Process(
        name = "RM_SEM_V3__Join_373_inner",
        properties = ModelTransform(modelName = "RM_SEM_V3__Join_373_inner"),
        input_ports = ["in_0", "in_1"]
    )
    rm_sem_v3__join_384_inner = Process(
        name = "RM_SEM_V3__Join_384_inner",
        properties = ModelTransform(modelName = "RM_SEM_V3__Join_384_inner"),
        input_ports = ["in_0", "in_1"]
    )
    rm_sem_v3__sort_377 = Process(
        name = "RM_SEM_V3__Sort_377",
        properties = ModelTransform(modelName = "RM_SEM_V3__Sort_377")
    )
    rm_sem_v3__summarize_323 = Process(
        name = "RM_SEM_V3__Summarize_323",
        properties = ModelTransform(modelName = "RM_SEM_V3__Summarize_323")
    )
    rm_sem_v3__summarize_367 = Process(
        name = "RM_SEM_V3__Summarize_367",
        properties = ModelTransform(modelName = "RM_SEM_V3__Summarize_367")
    )
    rm_sem_v3__summarize_370 = Process(
        name = "RM_SEM_V3__Summarize_370",
        properties = ModelTransform(modelName = "RM_SEM_V3__Summarize_370")
    )
    rm_sem_v3__summarize_379 = Process(
        name = "RM_SEM_V3__Summarize_379",
        properties = ModelTransform(modelName = "RM_SEM_V3__Summarize_379")
    )
    rm_sem_v3__googlesheetsoutput_476 = Process(
        name = "RM_SEM_V3__googlesheetsoutput_476",
        properties = ModelTransform(modelName = "RM_SEM_V3__googlesheetsoutput_476")
    )
    ...
    (
        ...
        >> [rm_sem_v3__join_311_left_unionleftouter._in(8), rm_sem_v3__join_311_left_unionleftouter._in(13),
              rm_sem_v3__join_384_inner._in(1)]
    )
    database__loadi_330 >> rm_sem_v3__alteryxselect_338._in(1)
    database__repor_351 >> rm_sem_v3__join_311_left_unionleftouter._in(11)
    (
    ...
    (
        ...
        >> [rm_sem_v3__join_311_left_unionleftouter._in(4), rm_sem_v3__join_311_left_unionleftouter._in(6)]
    )
    database__loadi_394 >> rm_sem_v3__join_311_left_unionleftouter._in(9)
    rm_sem_v3__summarize_323._out(0) >> [rm_sem_v3__alteryxselect_338._in(0), rm_sem_v3__join_329_inner._in(0)]
    database__loadi_292._out(0) >> [rm_sem_v3__join_311_left_unionleftouter._in(12), rm_sem_v3__summarize_379._in(0)]
    (
        database__loadi_283._out(0)
        >> [rm_sem_v3__join_311_left_unionleftouter._in(0), rm_sem_v3__join_311_left_unionleftouter._in(1),
              rm_sem_v3__join_311_left_unionleftouter._in(2),
              rm_sem_v3__join_311_left_unionleftouter._in(7), rm_sem_v3__join_384_inner._in(0)]
    )
    database__loadi_403 >> rm_sem_v3__alteryxselect_338._in(2)
    database__loadi_313 >> rm_sem_v3__alteryxselect_338._in(5)
    (
        rm_sem_v3__alteryxselect_338._out(0)
        >> [sem_support_lis_475._in(0), rm_sem_v3__summarize_367._in(0), rm_sem_v3__googlesheetsoutput_476._in(0)]
    )
    (
        database__loadi_341._out(0)
        >> [rm_sem_v3__join_311_left_unionleftouter._in(3), rm_sem_v3__join_311_left_unionleftouter._in(5)]
    )

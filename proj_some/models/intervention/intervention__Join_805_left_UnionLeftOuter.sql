...
Sample_808 AS (
  ...
  {{
    prophecy_basics.Sample(
      ['AlteryxSelect_804'], 
      '[{"name": "MBR_INDV_BE_KEY", "dataType": "String"}, {"name": "est_hh_income", "dataType": "String"}, {"name": "est_hh_income_range", "dataType": "String"}, {"name": "est_hh_income_range_low", "dataType": "String"}, {"name": "est_hh_income_range_high", "dataType": "String"}]', 
      'sampleGroup', 
      ['MBR_INDV_BE_KEY'], 
      1002, 
      'firstN', 

...
WITH DbFileInput_503_503 AS (
  ...
  FROM {{ prophecy_tmp_source('0_SUPPLY_PLANNING_CALCULATION_ENGINE_v0_4_1_', 'DbFileInput_503_503') }}
...
RLS20211129_001_615 AS (
  ...
  FROM {{ prophecy_tmp_source('0_SUPPLY_PLANNING_CALCULATION_ENGINE_v0_4_1_', 'RLS20211129_001_615') }}
...
DbFileInput_254_254 AS (
  ...
  FROM {{ prophecy_tmp_source('0_SUPPLY_PLANNING_CALCULATION_ENGINE_v0_4_1_', 'DbFileInput_254_254') }}
...
DbFileInput_255_255 AS (
  ...
  FROM {{ prophecy_tmp_source('0_SUPPLY_PLANNING_CALCULATION_ENGINE_v0_4_1_', 'DbFileInput_255_255') }}
...
Lineage11_01_21_570 AS (
  ...
  FROM {{ prophecy_tmp_source('0_SUPPLY_PLANNING_CALCULATION_ENGINE_v0_4_1_', 'Lineage11_01_21_570') }}
...
DbFileInput_127_127 AS (
  ...
  FROM {{ prophecy_tmp_source('0_SUPPLY_PLANNING_CALCULATION_ENGINE_v0_4_1_', 'DbFileInput_127_127') }}
...
DbFileInput_35_35 AS (
  ...
  FROM {{ prophecy_tmp_source('0_SUPPLY_PLANNING_CALCULATION_ENGINE_v0_4_1_', 'DbFileInput_35_35') }}
...
Filter_609 AS (
  ...
  WHERE (coalesce(((POSITION(LOWER('Totals for Item') IN LOWER(SKU))) > 0), FALSE))
...
DbFileInput_572_572 AS (
  ...
  FROM {{ prophecy_tmp_source('0_SUPPLY_PLANNING_CALCULATION_ENGINE_v0_4_1_', 'DbFileInput_572_572') }}

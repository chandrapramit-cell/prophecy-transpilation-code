...
WITH WarehouseMaster_129 AS (
  ...
  FROM {{ prophecy_tmp_source('0_SUPPLY_PLANNING_CALCULATION_ENGINE_v0_4_1_', 'WarehouseMaster_129') }}
...
Cleanse_316 AS (
  ...
  {{
    prophecy_basics.DataCleansing(
      ['AlteryxSelect_130'], 
      [
        { "name": "WH_ID_STANDARD", "dataType": "String" }, 
        { "name": "SOURCEWHDESCRIPTION", "dataType": "String" }, 
        { "name": "DUPLICATE SOURCE_WH_DESC IN WH MASTER FILE", "dataType": "String" }, 
        { "name": "DATE_OF_EVENT", "dataType": "String" }, 
        { "name": "SKU_CATEGORY", "dataType": "String" }, 
        { "name": "REMOVE THE DUPLICATE SOURCE_WH_DESC IN THE WH MASTER FILE", "dataType": "String" }, 
        ...
        { "name": "WH_DESC_STANDARD", "dataType": "String" }, 
        ...
        { "name": "13_WK_WKLY_AVG_SALES", "dataType": "String" }, 
        { "name": "ROWSORTTIER", "dataType": "String" }, 

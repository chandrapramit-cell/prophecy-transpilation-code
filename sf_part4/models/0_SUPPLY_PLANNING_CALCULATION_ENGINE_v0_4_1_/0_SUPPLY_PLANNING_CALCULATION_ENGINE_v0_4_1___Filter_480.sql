...
WITH WOH120921_xlsx__476 AS (
  ...
  FROM {{ prophecy_tmp_source('0_SUPPLY_PLANNING_CALCULATION_ENGINE_v0_4_1_', 'WOH120921_xlsx__476') }}
...
Formula_479_0 AS (
  ...
  SELECT 
    CAST((
      ...
      * 1
    ) AS STRING) AS "13_WK_WKLY_AVG_SALES",

...
MultiFieldFormula_544 AS (
  ...
  {{
    prophecy_basics.MultiColumnEdit(
      ['Cleanse_543'], 
      "((CASE WHEN ((((coalesce(CAST(CAST(column_value AS INTEGER) AS FLOAT), CAST((REGEXP_SUBSTR(CAST(column_value AS INTEGER), '^[0-9]+', 0)) AS INTEGER), 0)) / 1) < 0) AND ((((coalesce(CAST(CAST(column_value AS INTEGER) AS FLOAT), CAST((REGEXP_SUBSTR(CAST(column_value AS INTEGER), '^[0-9]+', 0)) AS INTEGER), 0)) / 1) - FLOOR(((coalesce(CAST(CAST(column_value AS INTEGER) AS FLOAT), CAST((REGEXP_SUBSTR(CAST(column_value AS INTEGER), '^[0-9]+', 0)) AS INTEGER), 0)) / 1))) = 0.5)) THEN CEIL(((coalesce(CAST(CAST(column_value AS INTEGER) AS FLOAT), CAST((REGEXP_SUBSTR(CAST(column_value AS INTEGER), '^[0-9]+', 0)) AS INTEGER), 0)) / 1)) ELSE ROUND(((coalesce(CAST(CAST(column_value AS INTEGER) AS FLOAT), CAST((REGEXP_SUBSTR(CAST(column_value AS INTEGER), '^[0-9]+', 0)) AS INTEGER), 0)) / 1)) END) * 1)", 
